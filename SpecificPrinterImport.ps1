...
$Printers_Name = @("Kyocera ECOSYS M5520cdn KX【衛生科辦公室彩色】")
$File_Name_suffix = "_x64.printerExport"
$File_Name = "SASEM5520"+ $File_Name_suffix  
$NowPrinters = @()
...
foreach($item in $Printers_Name){
    if(!($NowPrinters -Contains $item)){
        ...
        #$File_Name = "SASEM5520_x64"+"_x64.printerExport"
